  ...
  return (
    <>
      ...
      >
        <Scales />
        <Supercharge />
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-5 lg:gap-5">
              ...
              <div className="bg-neutral-900 p-2 group group">
                <div className="bg-neutral-950 border border-neutral-800 rounded-xl py-4 px-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <h2 className="dark:text-neutral-400 [&_b]:md:font-semibold [&_strong]:md:font-semibold md:mb-4 group-hover:ml-1 transition-all duration-300 ease-out">
                ...
                <div className="bg-neutral-950 border border-neutral-800 rounded-xl py-4 px-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <h2 className="dark:text-neutral-400 [&_b]:md:font-semibold [&_strong]:md:font-semibold md:mb-4 group-hover:ml-1 transition-all duration-300 ease-out">
                      ...
                      Gemini. The API understands the nuances of your code changes which allows it to provide suggestions that are remarkably accurate and human.
                    </h2>
                  </div>
                </div>
              </div>
